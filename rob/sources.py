...
SOURCES = (
    ...
    SourceDefinition(
        ...
        notes="Búsqueda OCR pública reproducida en pruebas; pendiente de validación final desde Render. SPARQL, OAI-PMH y Europeana quedan como apoyos de metadatos.",
    ),
    SourceDefinition(
        "galiciana_adg",
    ...
    SourceDefinition(
        ...
        status=SourceStatus.FUNCTIONAL,
        connector="rob.connectors.galiciana_ocr.GalicianaOCRConnector",
        notes="Busca dentro del OCR, devuelve obra, página, fragmentos, enlaces y una interpretación genealógica conservadora; pendiente de prueba final desde Render.",
    ),
